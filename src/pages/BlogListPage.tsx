...
export const BlogListPage: React.FC = () => {
  ...
  const filteredCategories = useMemo(
    () => (categories || []).filter((c: any) => (c.postsCount || 0) > 0),
    [categories]
  );
      ...
      <div className="flex items-end justify-between gap-2">
        <div>
          ...
          <p className="text-rocky-textMuted">
            Artículos y novedades de Rocky.
          </p>
        </div>
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-center gap-2 mt-6">
                  <button
                    ...
                    className="px-3 py-1.5 rounded-rockySm border border-rocky-border disabled:opacity-50"
                  >
                    Anterior
                  </button>
                  <span className="text-sm text-rocky-textMuted">
